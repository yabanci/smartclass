...
// newMockHA spins up an HA-shaped HTTP server used by the slow tests below.
// Lives in this file (not the shared helpers) so default-build doesn't see
// it as "unused" — only the slow-tagged tests reference it.
